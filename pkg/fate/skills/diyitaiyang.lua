local diyitaiyang = fk.CreateSkill{
  name = "yyfy_diyitaiyang",
  anim_type = "big",
  tags = { Skill.Charge },
}

Fk:loadTranslationTable{
  ["yyfy_diyitaiyang"] = "第一太阳",
  [":yyfy_diyitaiyang"] = "蓄力技（0/30），出牌阶段限一次，你可以消耗10点蓄力点，"..
  "赋予自身<a href=':yyfy_diyitaiyang_difference'>无敌贯通</a>状态，"..
  "并对任意名其他角色各造成2点伤害。然后，你令任意名有蓄力技的角色各获得1点蓄力点。",

  [":yyfy_diyitaiyang_difference"] = "<b>无敌贯通：</b><br>令其他角色本回合内受到你的伤害时改为失去体力。"
  ...
  ["$yyfy_diyitaiyang1"] = "风啊，风啊。夜之风啊，奴役吾等之人。灭亡之时已至。——去往下一个世界吧。别相·山之心脏。",
  ["$yyfy_diyitaiyang2"] = "只要是冥界就都一样。九个地下世界，十二之恐怖在太阳之下被统一。黑之特斯卡特利波卡……"
}
...
-- 顺便把必中也集成到这里，因为觉醒技不好添效果
diyitaiyang:addEffect(fk.CardUsing, {
  mute = true,
  on_cost = function(self, event, target, player, data)
    return player:hasSkill(self.name) and data.card.type ~= Card.TypeEquip
    and data.card.name ~= "peach" and data.card.name ~= "jink" and player:getMark("fate_bizhong") > 0
  end,
  on_use = function(self, event, target, player, data)
