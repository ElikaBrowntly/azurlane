...
Fk:loadTranslationTable{
  ...
  [":fate_diyitaiyang"] = "蓄力技（0/300），出牌阶段限一次，你可以消耗100点蓄力点，"..
  "令其他角色本回合内<a href=':fate_diyitaiyang_difference'>受到你的伤害时改为失去体力</a>，"..
  "并对任意名其他角色各造成2点伤害。然后，你令任意名有蓄力技的角色各获得10点蓄力点。",

  [":fate_diyitaiyang_difference"] = "该描述与<b>绝情:你造成的伤害均视为失去体力</b>的区别在于时机更晚。<br>"
