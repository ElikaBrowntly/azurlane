...
Fk:loadTranslationTable{
  ["lan__guili"] = "归离",
  [":lan__guili"] = "锁定技，游戏开始时，你选择一名其他角色。该角色的回合结束时，你执行一个额外的回合。",
...
guili:addEffect(fk.GameStart, {
  anim_type = "support",
  can_trigger = function(self, event, target, player, data)
    return player and player:hasSkill(guili.name) and #player.room:getOtherPlayers(player) > 0
  end,
