...
Fk:loadTranslationTable{
  ...
  ["yyfy_qizha-nocheat1"] = "我从不骗人",
  ["yyfy_qizha-cheat1"] = "我从不相信任何人说的话，包括我自己",
  ["yyfy_qizha-nocheat2"] = "我从不骗人",
  ["yyfy_qizha-cheat2"] = "我从不相信任何人说的话，包括我自己",
...
qizha:addEffect("active", {
  ...
  on_use = function(self, room, effect)
    ...
    if choice1[12] == choice2[12] then -- 发动者没赢
      if invoked then
        room:doBroadcastNotify("ShowToast", Fk:translate(player.general).."对"..Fk:translate(to.general).."的谋弈 失败")
      end
      return
    end
