...
Fk:loadTranslationTable{
  ["lan__qingzheng"] = "清正",
  [":lan__qingzheng"] = "持恒技，出牌阶段开始时，你可以选择一名有手牌的其他角色，你弃置一种花色的所有手牌，" ..
  "然后观看其手牌并选择一种花色的牌，其弃置该花色所有手牌，然后你对其造成1点伤害。",

  ["#lan__qingzheng-card"] = "清正：你可以弃置一种花色的手牌，观看一名角色的手牌并弃置其中一种花色",
  ["#lan__qingzheng-choose"] = "清正：选择一名其他角色，观看其手牌并弃置其中一种花色",
  ["#lan__qingzheng-throw"] = "清正：弃置 %dest 一种花色的手牌，然后对其造成1点伤害",
