...
Fk:loadTranslationTable{
  ["yyfy_lead"] = "领导",
  [":yyfy_lead"] = "锁定技，你参与议事的意见视为+1。一名角色的回合开始时，你可以令所有角色“<a href='yyfy_lead-yishi'>议事</a>”；"..
  "然后你摸X张牌并回复等量体力（X为红色意见数量）。若结果为红色，你可令意见为黑色的其他角色弃置所有牌并失去一点体力。",

  ["yyfy_lead-yishi"] = "江山如故-起包提出的概念，技能发动者先指定参与议事的其他目标角色，然后所有参与议事的角色提出各自的意见（同时展示一张手牌，展示牌的颜色表示该角色在议事中提出的意见）（没有手牌则不展示），对比两种意见提出者的数量，意见提出者数量最多的颜色将作为本次议事的结果，然后由议事发起者执行结果对应颜色的效果。"..
  "目前涉及议事的武将：<br>"..
